function kattintevkeres(){
    ...
    if(isNaN(bekeres)){
        document.getElementById("kiiras").innerHTML="Kérlek számot adj meg!"
    }
    else{
        var utolsoev=parseInt(prizes.prizes[0].year)
        if(bekeres>utolsoev || bekeres<1901){
            document.getElementById("kiiras").innerHTML="Kérlek adj meg létező évszámot(2023 és 1901)!"
        }
        else{
            var szovegecske=""
            szovegecske+=`<ul>`
